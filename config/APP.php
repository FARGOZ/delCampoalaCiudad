<?php
	...
	----------*/
	const SERVERURL="http://localhost/CLC/";


	/*----------  
	Nombre de la empresa o compañia -  Company or company name
	----------*/
	const COMPANY="Del Campo a la Ciudad";
	...
	/*----------  
	Nombre de la sesion -  Session name STO
	----------*/
	const SESSION_NAME="CLC"; 
	...
	/*----------  Direccion - Address  ----------*/
	const COUNTRY="El Bagre (Antioquia)";
	const ADDRESS="Barrio EL Bijao";
	

	/*----------  Configuración de moneda - Currency Settings  ----------*/
	const COIN_SYMBOL="$";
	const COIN_NAME="PESOS";
